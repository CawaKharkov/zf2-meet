 ...
 */
class UserIdentity implements ProviderInterface
{
    /**
     * @var EntityManager
     */
    ...
    public function getIdentityRoles()
    {
        ...
        if (!$authService->hasIdentity()) {
            ...
            $builder->select("linker.role_id")
                ...
                ->where('linker.user_email = :user_email')
                ->setParameter('user_email', $authService->getIdentity()->getEmail());
            //var_dump($authService->getIdentity()->getEmail());
            //var_dump($builder->getSQL());die();
